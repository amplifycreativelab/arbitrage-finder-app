...
function App() {
    ...
    return (<div className="flex min-h-screen flex-col bg-ot-background text-ot-foreground">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-md bg-ot-accent/10">
              <img alt="Arbitrage Finder" className="h-6 w-6" src={electron_svg_1.default}/>
            </div>
            <div>
          ...
          <button_1.Button className="hidden text-[11px] sm:inline-flex" onClick={handlePing}>
            Ping main process
          </button_1.Button>
        </div>
      </header>
