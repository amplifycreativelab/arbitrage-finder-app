...
function FeedFilters({ totalCount, filteredCount, availableBookmakers }) {
    ...
    const renderFilterChip = (label, active, onClick, testId) => {
        return ((0, jsx_runtime_1.jsx)("button", { type: "button", className: (0, utils_1.cn)('rounded-full border px-2 py-[2px] text-[9px] font-medium', active
                ...
                : 'border-ot-border text-ot-muted hover:border-ot-accent/60 hover:text-ot-accent'), "data-testid": testId, "aria-pressed": active ? 'true' : 'false', onClick: onClick, children: label }, testId));
    };
    return ((0, jsx_runtime_1.jsxs)("section", { className: "mb-2 space-y-2 border-b border-ot-border pb-2 text-[10px]", "aria-label": "Feed filters", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-2", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[10px] font-semibold uppercase tracking-[0.14em] text-ot-muted", children: "Filters" }), (0, jsx_runtime_1.jsxs)("span", { className: "text-[10px] text-ot-muted", children: [filteredCount, " of ", totalCount, " shown"] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap gap-2", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap items-center gap-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[10px] text-ot-muted", children: "Region" }), ['AU', 'UK', 'IT', 'RO'].map((code) => renderFilterChip(code, regions.includes(code), () => handleToggleRegion(code), `feed-filters-region-${code}`))] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap items-center gap-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[10px] text-ot-muted", children: "Sport" }), ['soccer', 'tennis'].map((sport) => renderFilterChip(sport === 'soccer' ? 'Soccer' : 'Tennis', sports.includes(sport), () => handleToggleSport(sport), `feed-filters-sport-${sport}`))] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[10px] text-ot-muted", children: "Bookmaker" }), (0, jsx_runtime_1.jsx)(BookmakerFilterPopover_1.BookmakerFilterPopover, { availableBookmakers: availableBookmakers })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[10px] text-ot-muted", children: "Market" }), (0, jsx_runtime_1.jsx)(MarketFilterPopover_1.MarketFilterPopover, {})] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[10px] text-ot-muted", children: "Min ROI" }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-1", children: [(0, jsx_runtime_1.jsx)(input_1.Input, { type: "number", className: "h-6 w-16 px-1 py-0 text-[10px]", value: minRoiPercent, onChange: handleMinRoiChange, placeholder: "0.0", min: "0", step: "0.5", "data-testid": "feed-filters-min-roi" }), (0, jsx_runtime_1.jsx)("span", { className: "text-[10px] text-ot-muted", children: "%" })] })] })] }), hasActiveFilters && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-2 text-[10px] text-ot-muted", children: [(0, jsx_runtime_1.jsx)("span", { children: "Active filters applied." }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "text-[10px] text-ot-accent hover:underline", onClick: () => resetFilters(), "data-testid": "feed-filters-reset", children: "Reset" })] }))] }));
}
...
function FeedPane() {
    ...
    if (error && noUnderlyingData) {
        ...
        content = ((0, jsx_runtime_1.jsx)("div", { className: "flex h-full items-center justify-center text-[11px] text-ot-muted", role: "status", "data-testid": "feed-loading", children: "Loading opportunities..." }));
    }
    else if (hasUnderlyingData && filteredCount === 0) {
        content = ((0, jsx_runtime_1.jsx)("div", { className: "flex h-full items-center justify-center text-[11px] text-ot-muted", "data-testid": "feed-empty-filters", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col items-center gap-2", children: [(0, jsx_runtime_1.jsx)("p", { children: "No opportunities match the current filters." }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "text-[10px] text-ot-accent hover:underline", onClick: () => feedFiltersStore_1.useFeedFiltersStore.getState().resetFilters(), children: "Reset Filters" })] }) }));
    }
        ...
        if (hasUnhealthyStatus) {
            ...
            const lastUpdatedLabel = fetchedAt != null
                ? (0, staleness_1.getStalenessInfo)({ foundAt: fetchedAt }, stalenessNow).label || ''
                : '';
            content = ((0, jsx_runtime_1.jsxs)("div", { className: "flex h-full flex-col items-center justify-center space-y-1 text-center text-[11px] text-ot-muted", "data-testid": "feed-empty-healthy", children: [(0, jsx_runtime_1.jsx)("p", { children: "No current surebets. System and providers are healthy." }), lastUpdatedLabel && ((0, jsx_runtime_1.jsxs)("p", { className: "text-[10px] text-ot-muted/70", children: ["Last update ", lastUpdatedLabel, "."] }))] }));
        }
    }
    else {
