...
function FilterBar({ totalCount, filteredCount, availableBookmakers, sourceFilter, onSourceFilterChange, sortBy, onSortChange }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { className: "rounded-lg border border-ot-border bg-gradient-to-b from-ot-surface to-ot-background p-3", "aria-label": "Feed filters", "data-testid": "filter-bar", children: [(0, jsx_runtime_1.jsxs)("div", { className: "mb-3 flex items-center justify-between", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3", children: [(0, jsx_runtime_1.jsx)("h3", { className: "text-[11px] font-bold uppercase tracking-[0.16em] text-ot-foreground", children: "Filters" }), (0, jsx_runtime_1.jsxs)("span", { className: "rounded-full bg-ot-accent/10 px-2 py-0.5 text-[10px] font-semibold text-ot-accent", children: [filteredCount, " / ", totalCount] })] }), hasActiveFilters && ((0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: handleReset, className: "group flex items-center gap-1 rounded-full border border-ot-border px-2 py-0.5 text-[9px] font-medium text-ot-muted transition-all hover:border-red-300/50 hover:bg-red-50 hover:text-red-500", "data-testid": "filter-bar-reset", children: [(0, jsx_runtime_1.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: "h-3 w-3 transition-transform group-hover:rotate-180", children: [(0, jsx_runtime_1.jsx)("path", { d: "M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8" }), (0, jsx_runtime_1.jsx)("path", { d: "M3 3v5h5" })] }), "Reset All"] }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "space-y-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap items-end gap-4", children: [(0, jsx_runtime_1.jsx)(FilterDropdown_1.MultiFilterChipGroup, { label: "Region", options: REGION_OPTIONS, selected: regions, onToggle: (value) => toggleRegion(value), testIdPrefix: "filter-region" }), (0, jsx_runtime_1.jsx)(FilterDropdown_1.MultiFilterChipGroup, { label: "Sport", options: SPORT_OPTIONS, selected: sports, onToggle: (value) => toggleSport(value), testIdPrefix: "filter-sport" }), (0, jsx_runtime_1.jsx)("div", { className: "ml-auto", children: (0, jsx_runtime_1.jsx)(FilterDropdown_1.FilterDropdown, { label: "Sort By", options: SORT_OPTIONS, value: sortBy, onChange: onSortChange, testId: "filter-sort-by" }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap items-end gap-3 border-t border-ot-border/60 pt-3", children: [(0, jsx_runtime_1.jsx)(FilterDropdown_1.FilterDropdown, { label: "Source", options: SOURCE_OPTIONS, value: sourceFilter, onChange: onSourceFilterChange, testId: "filter-source" }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("label", { className: "text-[9px] font-semibold uppercase tracking-[0.14em] text-ot-muted", children: "Market" }), (0, jsx_runtime_1.jsx)(MarketFilterPopover_1.MarketFilterPopover, {})] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("label", { className: "text-[9px] font-semibold uppercase tracking-[0.14em] text-ot-muted", children: "Bookmaker" }), (0, jsx_runtime_1.jsx)(BookmakerFilterPopover_1.BookmakerFilterPopover, { availableBookmakers: availableBookmakers })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("label", { htmlFor: "min-roi-input", className: "text-[9px] font-semibold uppercase tracking-[0.14em] text-ot-muted", children: "Min ROI" }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-1", children: [(0, jsx_runtime_1.jsx)(input_1.Input, { id: "min-roi-input", type: "number", className: (0, utils_1.cn)('h-8 w-20 px-2.5 text-[11px]', hasActiveRoi && 'border-ot-accent/50 bg-ot-accent/5'), value: minRoiPercent, onChange: handleMinRoiChange, placeholder: "0.0", min: "0", step: "0.5", "data-testid": "filter-min-roi" }), (0, jsx_runtime_1.jsx)("span", { className: "text-[10px] font-medium text-ot-muted", children: "%" })] })] }), hasActiveFilters && ((0, jsx_runtime_1.jsxs)("div", { className: "ml-auto flex items-center gap-2 rounded-md bg-ot-accent/5 px-2 py-1", children: [(0, jsx_runtime_1.jsx)("div", { className: "h-1.5 w-1.5 animate-pulse rounded-full bg-ot-accent" }), (0, jsx_runtime_1.jsx)("span", { className: "text-[9px] font-medium text-ot-accent", children: "Filters Active" })] }))] })] })] }));
}
