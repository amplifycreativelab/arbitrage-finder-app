  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      >
        <section
          aria-label="Feed"
          className="flex flex-1 min-w-[360px] flex-col gap-3 border-r border-ot-border pr-4"
        ...
        >
          <div
            className="flex-1 rounded-md border border-ot-border bg-ot-background p-3"
          ...
          >
            <header className="flex items-center justify-between gap-2">
              ...
              <span className="text-[10px] text-ot-muted">Layout shell</span>
            </header>

            <div className="mt-2 flex h-full flex-col rounded-md border border-ot-border bg-ot-background p-3 text-[11px] font-mono text-ot-foreground">
